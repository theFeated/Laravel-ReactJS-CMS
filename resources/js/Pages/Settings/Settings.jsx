...
export default function Settings({ isGoogleAuthEnabled, is2FAEnabled, webIcon, webName, set_logo, isGoogle2FAEnabled, isDarkModeEnabled, isCaptchaSliderEnabled, isStandardLoginEnabled  }) {
    ...
    const renderActiveTab = () => {
        switch (activeTab) {
            ...
            case 'manual-login': return <EnableStandardLogin initialIsManualLoginEnabled={isStandardLoginEnabled} userId={auth.user.id} />; 
