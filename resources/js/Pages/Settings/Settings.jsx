...
import EnableManualLogin from './Partials/EnableManualLogin';

export default function Settings({ isGoogleAuthEnabled, is2FAEnabled, webIcon, webName, set_logo, isGoogle2FAEnabled, isDarkModeEnabled, isCaptchaSliderEnabled, isManualLoginEnabled  }) {
    ...
    const renderActiveTab = () => {
        switch (activeTab) {
            ...
            case 'manual-login': return <EnableManualLogin initialIsManualLoginEnabled={isManualLoginEnabled} userId={auth.user.id} />; // Add this case
            default: return null;
        }
    };
                        ...
                        <div className="flex justify-between w-full max-w-7xl mx-auto">
                            ...
                            >
                             ...
                             <button
                                ...
                                onClick={() => setActiveTab('manual-login')}
                            >
                                Manual Login
                            </button>
                        </div>
